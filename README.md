...
> [!IMPORTANT]
> This repository does not accept contributions via github and is now maintained at [git.rubydelusion.net](https://git.rubydelusion.net/alex/Breakglass-dynamic-secrets).
